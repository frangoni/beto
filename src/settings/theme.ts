export const PALETTES = [
	['rgba(242, 0, 137, 1)', 'rgba(0, 242, 195, 1)'], // Fuchsia and Aqua
	['rgba(171, 196, 171, 1)', 'rgba(109, 76, 61, 1)'], // Mint Green and Cocoa
	['rgba(192, 255, 0, 1)', 'rgba(111, 0, 255, 1)'], // Lime and Electric Purple
	['rgba(7, 9, 13, 1)', 'rgba(245, 208, 197, 1)'], // Dark Slate and Peach
	['rgba(255, 79, 0, 1)', 'rgba(23, 190, 187, 1)'], // Flame Orange and Teal

	['rgba(25, 25, 112, 1)', 'rgba(255, 127, 80, 1)'], // Midnight Blue and Coral
	['rgba(60, 179, 113, 1)', 'rgba(106, 90, 205, 1)'], // Medium Sea Green and Slate Blue
	['rgba(255, 20, 147, 1)', 'rgba(255, 215, 0, 1)'], // Deep Pink and Gold
	['rgba(255, 105, 180, 1)', 'rgba(0, 191, 255, 1)'], // Hot Pink and Deep Sky Blue
	['rgba(220, 20, 60, 1)', 'rgba(124, 252, 0, 1)'], // Crimson and Lawn Green
